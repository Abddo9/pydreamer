...
class TSSMCore(nn.Module):
    ...
    def __init__(self, embed_dim, action_dim, deter_dim, stoch_dim, stoch_discrete, hidden_dim, layer_norm):
        super().__init__()
        self.cell = TSSMCell(embed_dim, action_dim, deter_dim, stoch_dim, stoch_discrete, hidden_dim, layer_norm)
...
class TSSMCell(nn.Module):
    ...
    def __init__(self, embed_dim, action_dim, deter_dim, stoch_dim, stoch_discrete, hidden_dim, layer_norm):
        ...
        self.trans = trans.TRANSEncoder(hidden_dim)
